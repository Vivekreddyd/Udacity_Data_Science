...
# if False:
data = {'year': pd.Series([2010, 2011, 2012, 2011, 2012, 2010, 2011, 2012], index=['a','b','c','d','e','f','g','h']),
        'team': pd.Series(['Bears', 'Bears', 'Bears', 'Packers', 'Packers', 'Lions',
                 'Lions', 'Lions'],index=['a','b','c','d','e','f','g','h']),
        'wins': [11, 8, 10, 15, 11, 6, 10, 4],
        'losses': [5, 8, 6, 1, 5, 10, 6, 12]}
football = pd.DataFrame(data)
print(football)
